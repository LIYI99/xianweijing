...
#define XW_MANUL_WHITE_BALANCE_WINDOW_X    XW_MAIN_WINDOW_X + 0
#define XW_MANUL_WHITE_BALANCE_WINDOW_Y     XW_MAIN_WINDOW_Y + 0



#define XW_AE_MANUL_WINDOW_X           XW_MAIN_WINDOW_X + 0
#define XW_AE_MANUL_WINDOW_Y            XW_MAIN_WINDOW_Y + 0
#define XW_MANUL_EXPOUSURE_TEXT_WINDOW_X   XW_MAIN_WINDOW_X + 0
#define XW_MANUL_EXPOUSURE_TEXT_WINDOW_Y   XW_MAIN_WINDOW_Y + 0
